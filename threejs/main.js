...
function goToNext(){
	const url = `http://localhost:5173/results.html?GID=${gameId}&QID=${questionId}`; 
...
async function loadSVG(svgRef, playerName, playerAns) {
    ...
    try {
		...
		console.log(randomColor,playerAns,":",group.position.x, group.position.y)
